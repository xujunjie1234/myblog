...
from myblog.extensions import bootstrap, db, login_manager, csrf, ckeditor, moment, mail, whooshee, toolbar, migrate
...
def register_template_context(app):
    ...
    def make_template_context():
        ...
        return dict(
            admin=admin, categories=categories,unread_comments=unread_comments)
